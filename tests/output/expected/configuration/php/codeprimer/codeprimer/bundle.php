...
function prepareBundle(string $name = 'FunctionalTest', string $namespace = 'CodePrimer Tests', string $description = 'This is a sample BusinessBundle used to test CodePrimer functionality')
{
